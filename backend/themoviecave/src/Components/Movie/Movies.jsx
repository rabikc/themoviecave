...
const Movies = () => {
  ...
  const fetchMovies = async () => {
    ...
    const { data } = await axios.get(
      `${rootUrl}/discover/movie?api_key=${process.env.REACT_APP_API_KEY}&language=en-US
  ...
  const search = async (e) => {
    try {
      const { data } = await axios.get(
        `${rootUrl}/search/movie?api_key=${process.env.REACT_APP_API_KEY}&language=en-US&query=${searchText}&page=${page}&include_adult=false`
      )
      setContent(data.results);
      setNumOfPages(data.total_pages)
    }
  ...
  //   try {
  //     const { data } = await axios.get(
  //       `${rootUrl}/movie/top_rated?api_key=${process.env.REACT_APP_API_KEY}&language=en-US&${page}&include_adult=false&with_genres=${genreforURL}`
  //     )
  //     setContent(data.results);
  //     setNumOfPages(data.total_pages);
  //     console.log(data)
  ...
  //   data.then(r => {
  //     setContent(r.results);
  //     setNumOfPages(r.total_pages);
  //     console.log(r)
  //   })
  // }
  ...
  //   try {
  //     const { data } = await axios.get(
  //       `${rootUrl}/movie/popular?api_key=${process.env.REACT_APP_API_KEY}&language=en-US${page}&include_adult=false&with_genres=${genreforURL}`
  //     )
  //     setContent(data.results);
  //     setNumOfPages(data.total_pages);
  //     console.log(data)
  ...
  //   try {
  //     const { data } = await axios.get(
  //       `${rootUrl}/movie/upcoming?api_key=${process.env.REACT_APP_API_KEY}&language=en-US&${page}&include_adult=false&with_genres=${genreforURL}`
  //     )
  //     setContent(data.results);
  //     setNumOfPages(data.total_pages);
  //     console.log(data)
      ...
      <aside className='movies-sidebar'>
        ...
        <div className="sort-by">
          ...
          {/* <div className="sort-categories">
            <button onClick={displayTop} className='top-rated-btn'>Top Rated</button>
            <button onClick={fetchMovies} className='popular-btn'>Popular</button>
            <button onClick={displayUpcoming} className='upcoming-btn'>Upcoming</button>
          </div> */}
        </div>
      </aside>
