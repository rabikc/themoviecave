...
const SignUp = () => {
  ...
  const [signUp, setSignUp] = useState({ first_name: '', last_name:'', username: '', email: '', password: '',re_password:'' });

  const [message, setMessage] = useState()

  const { first_name,last_name, username, email, password, re_password } = signUp;
  ...
  const submitHandler = async (e) => {
    ...
    if(data.statusText === 'Created'){
      ...
      setSignUp({first_name: '', last_name:'', username: '', email: '', password: '',re_password:'' })
    }
  }
        ...
        <form onSubmit={submitHandler}>
          ...
          <div className="form-input">
            ...
            <div className="form-input">
              ...
              <input type="password" name='re_password' required value={re_password} onChange={changeHandler}/>
            </div>
          </div>
