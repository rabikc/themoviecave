                ...
                <div className="trending-flex-display">
                    {
                        movie && movie.map((x,i) =>
                            <div to="#" className="trending-single-content" key={i}>
                                ...
                                <Link to={`/movie/${x.id}/${x.title}`} className="trending-image-link">
                                ...
                                <Link to={`/movie/${x.id}/${x.title}`} className="content-title" alt={x.title}>{x.title || x.name}</Link>
                ...
                <div className="trending-flex-display">
                    {
                        tv && tv.map((x,i) =>
                            <div to="#" className="trending-single-content" key={i}>
                                <span className="content-id">{x.id}</span>
                                <Link to={`/tv/${x.id}/${x.name}`} className="trending-image-link">
